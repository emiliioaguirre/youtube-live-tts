export const translations = {
  en: {
    ...
    sixtydbKeyConfigured: "SIXTYDB_API_KEY detected on the server",
    sixtydbKeyMissing: "Set SIXTYDB_API_KEY on the server to use 60db",
    sixtydbVoicePlaceholder: "60db voice ID (UUID)",
  ...
  es: {
    ...
    sixtydbKeyConfigured: "SIXTYDB_API_KEY detectada en el servidor",
    sixtydbKeyMissing: "Configura SIXTYDB_API_KEY en el servidor para usar 60db",
    sixtydbVoicePlaceholder: "ID de voz de 60db (UUID)",
